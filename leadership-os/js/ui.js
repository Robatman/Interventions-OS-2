...
?.addEventListener('click', () => {
  ...
  document.getElementById('screen-interventions')
...
// INTERVENTIONS → BACK
// =========================
document.getElementById('btn-interventions-back')
?.addEventListener('click', () => {
...
?.addEventListener('click', () => {
  ...
  document.getElementById('screen-techniques')
    ?.setAttribute('visible', true);
...
// TECHNIQUES → BACK
// =========================
document.getElementById('btn-techniques-back')
?.addEventListener('click', () => {
